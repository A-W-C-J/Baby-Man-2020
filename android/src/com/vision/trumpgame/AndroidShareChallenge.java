    ...
    public void shareScreenshot(final boolean ok) {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                final String text = "https://play.google.com/store/apps/details?id=com.vision.elimination";
                ...
                context.startActivity(Intent.createChooser(shareIntent, "Trump game,have fun!"));
            }
        });
    }
}
