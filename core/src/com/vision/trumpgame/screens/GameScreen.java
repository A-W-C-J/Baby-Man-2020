...
import com.vision.trumpgame.serializer.BinSerializer;
import com.vision.trumpgame.Klooni;
import com.vision.trumpgame.game.BaseScorer;
import com.vision.trumpgame.game.Board;
import com.vision.trumpgame.game.BonusParticleHandler;
import com.vision.trumpgame.game.GameLayout;
import com.vision.trumpgame.game.Piece;
import com.vision.trumpgame.game.PieceHolder;
import com.vision.trumpgame.game.Scorer;
import com.vision.trumpgame.game.TimeScorer;
import com.vision.trumpgame.serializer.BinSerializable;
...
public class GameScreen implements Screen, InputProcessor, BinSerializable {
    ...
    private final static String SAVE_DAT_FILENAME = ".trump.sav";
    private final static String SAVE_DAT_FILENAME15 = ".trump15.sav";
    private final static String SAVE_DAT_FILENAME20 = ".trump20.sav";
    //endregion
    ...
    GameScreen(final Klooni game, final int gameMode, final boolean loadSave) {
        ...
        if (!"Ghost".equals(Klooni.theme.getDisplay()))
            gameOverSound = Gdx.audio.newSound(Gdx.files.internal("sound/game_over_trump.mp3"));
        else
